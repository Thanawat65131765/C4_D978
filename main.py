...
# Load the dataset
df = pd.read_csv("D:\\65109076\\LSTM_Model\\greenhouse\\datasheet4_resampling_with_condition_4885.csv", encoding="utf8")
...
input_features = [
            'Temp', 'Humid', 'LightIntensity', 'Treatment', 'SoilMoistureIndex', 'WeatherCondition'
]
